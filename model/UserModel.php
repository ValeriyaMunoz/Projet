...
try{
      ...
      //$db = connect();
        global $db;
    $query=$db->prepare('UPDATE '.$this->table.' SET nom=:nom, prenom=:prenom, username=:username, adresse=:adresse, email=:email, code_postale=:code_postale, telephone=:telephone, date_naissance=:date_naissance, ville=:ville, url_photo_profil=:url_photo_profil WHERE id=:id');
